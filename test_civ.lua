...
T.init = function()
  local metaty_init = core.initpkg(D..'lib/metaty/PKG.lua')
  T.eq(METATY_PKG, metaty_init)

  local fmt_init = core.initpkg(D..'lib/fmt/PKG.lua')
  T.eq(fmt_init.import, {
    lua = 'sys:lua',
...
local function newCiv()
  ...
  return core.Civ{cfg=core.Cfg{buildDir= O, hubs=HUBS}}
end
