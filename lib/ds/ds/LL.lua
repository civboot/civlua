...
-- Link DSL: l1 - l2 ==> l1 -> l2
-- Links l:tail() -> r:head(), returns r:tail()
-- This is for convienience and expressiveness of small lists.
-- Use link() directly if performance matters.
--
-- Example:
