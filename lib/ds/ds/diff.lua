...
local skipEqLinesTop = function(linesB, linesC, b, b2, c, c2)
...
local skipEqLinesBot = function(linesB, linesC, b, b2, c, c2)
  while b <= b2 and c <= c2 do
...
local diffI
diffI = function(diff, linesB, linesC, b, b2, c, c2)
  local bSt, b2St = b, b2
  ...
  for i=#lis,0,-1 do
    ...
    diffI(diff, linesB, linesC, b, bNext, c, cNext)
...
M._forTest = {
  ...
  findLeftStack = findLeftStack,
  patienceLIS   = patienceLIS,
}
